  ...
  methods: {
    ...
    onFileChange(event) {
      ...
      if (file) {
        ...
        if (file.name === "2.mp4") {
          this.resultVideoURL1 = "/video/java2.mp4";
          // this.resultVideoURL2 = "/2_0.mp4";
        } else if (file.name === "1.mp4") {
          // this.resultVideoURL1 = "/1.mp4";
          this.resultVideoURL1 = "/video/java1.mp4";          
          // this.resultVideoURL2 = "/1_0.mp4";
        } else if (file.name === "3.mp4") {
          this.resultVideoURL1 = "/video/java3.mp4";
          // this.resultVideoURL2 = "/3_0.mp4";
        } else if (file.name === "4.mp4") {
          // this.resultVideoURL1 = "/4.mp4";
          this.resultVideoURL1 = "/video/java4.mp4";
        } else if (file.name === "5.mp4") {
          // this.resultVideoURL1 = "/5.mp4";
          this.resultVideoURL1 = "/video/java5.mp4";
        } else if (file.name === "6.mp4") {
          // this.resultVideoURL1 = "/6.mp4";
          this.resultVideoURL1 = "/video/java6.mp4";
        } else if (file.name === "7.mp4") { 
          // this.resultVideoURL1 = "/7.mp4";
          this.resultVideoURL1 = "/video/java7.mp4";
        } else if (file.name === "8.mp4") {
          // this.resultVideoURL1 = "/8.mp4";
          this.resultVideoURL1 = "/video/java8.mp4";
        }
